...
(function () {
  ...
  var I18N = {
    "zh-Hans": {
      ...
      p_s1t: "1 · 布置场景",
      p_s1p: "挑一到三种类型、一种语言，以及文字的成熟程度。有角色就加进来——或者全部留白，看看 Capy 会编出什么。",
      p_s2t: "2 · 分享代码",
      p_s2p: "大家用四个字符加入，手机或浏览器都行。不用注册、不用账号、不用邮箱。",
      p_s3t: "3 · 轮流接力",
      p_s3p: "Capy 写下一段，然后提出一个问题。主持人把笔交给回答的人——故事就在他的选择上转弯。",
    ...
    "zh-Hant": {
      ...
      p_s1t: "1 · 佈置場景",
      p_s1p: "挑一到三種類型、一種語言，以及文字的成熟程度。有角色就加進來——或者全部留白，看看 Capy 會編出什麼。",
      p_s2t: "2 · 分享代碼",
      p_s2p: "大家用四個字元加入，手機或瀏覽器都行。不用註冊、不用帳號、不用電子郵件。",
      p_s3t: "3 · 輪流接力",
      p_s3p: "Capy 寫下一段，然後提出一個問題。主持人把筆交給回答的人——故事就在他的選擇上轉彎。",
    ...
    "ja": {
      ...
      p_s1t: "1 · 舞台をととのえる",
      p_s1p: "ジャンルを1〜3つ、言語、そして文章の大人っぽさを選びます。登場人物がいれば加えて——全部空欄にして、Capy が何を思いつくか見るのもあり。",
      p_s2t: "2 · コードを共有",
      p_s2p: "みんな4文字で参加。スマホでもブラウザでも。アカウントも登録もメールも不要です。",
      p_s3t: "3 · 順番に書く",
      p_s3p: "Capy が一節を書き、問いかけます。ホストは答える人にペンを渡す——物語はその選択で曲がります。",
    ...
    "ko": {
      ...
      p_s1t: "1 · 무대를 정해요",
      p_s1p: "장르 하나에서 셋, 언어, 그리고 문장이 얼마나 어른스러울지를 고르세요. 등장인물이 있으면 넣고 — 아니면 전부 비워 두고 Capy가 무엇을 지어내는지 보세요.",
      p_s2t: "2 · 코드를 나눠요",
      p_s2p: "모두 네 글자로 참여합니다. 휴대폰에서도, 브라우저에서도. 계정도 가입도 이메일도 필요 없어요.",
      p_s3t: "3 · 번갈아 써요",
      p_s3p: "Capy가 한 대목을 쓰고 질문을 던집니다. 호스트는 답하는 사람에게 펜을 넘기고 — 이야기는 그 선택에서 방향을 틉니다.",
