...
(function () {
  ...
  var I18N = {
    "zh-Hans": {
      ...
      p_peek_title: "看看里面 👀", p_peek_sub: "一个进行中的故事，四个画面。📱",
    ...
    "zh-Hant": {
      ...
      p_peek_title: "看看裡面 👀", p_peek_sub: "一個進行中的故事，四個畫面。📱",
    ...
    "ja": {
      ...
      p_peek_title: "中をのぞいてみる 👀", p_peek_sub: "進行中の物語から、4つの画面。📱",
    ...
    "ko": {
      ...
      p_peek_title: "안을 살짝 들여다보기 👀", p_peek_sub: "진행 중인 이야기의 네 화면. 📱",
    ...
    "es": {
      ...
      p_how_sub: "Rápido de empezar. Sin prisa por terminar. 🌿",
      ...
      p_peek_title: "Un vistazo por dentro 👀", p_peek_sub: "Cuatro pantallas de una historia en marcha. 📱",
    ...
    "fr": {
      ...
      p_how_sub: "Vite commencé. Rien ne presse pour finir. 🌿",
      ...
      p_peek_title: "Un aperçu de l'intérieur 👀", p_peek_sub: "Quatre écrans d'une histoire en cours. 📱",
    ...
    "de": {
      ...
      p_how_sub: "Schnell begonnen. Keine Eile beim Beenden. 🌿",
      ...
      p_peek_title: "Ein Blick hinein 👀", p_peek_sub: "Vier Bildschirme aus einer laufenden Geschichte. 📱",
    ...
    "it": {
      ...
      p_how_sub: "Si comincia in fretta. Si finisce con calma. 🌿",
      ...
      p_peek_title: "Uno sguardo dentro 👀", p_peek_sub: "Quattro schermate di una storia in corso. 📱",
    ...
    "pt-BR": {
      ...
      p_how_sub: "Rápido de começar. Sem pressa para terminar. 🌿",
      ...
      p_peek_title: "Uma espiada por dentro 👀", p_peek_sub: "Quatro telas de uma história em andamento. 📱",
    ...
    "ru": {
      ...
      p_how_sub: "Начать — быстро. Закончить — без спешки. 🌿",
      ...
      p_peek_title: "Заглянем внутрь 👀", p_peek_sub: "Четыре экрана из истории в процессе. 📱",
    ...
    "nl": {
      ...
      p_how_sub: "Snel begonnen. Geen haast om te eindigen. 🌿",
      ...
      p_peek_title: "Een kijkje binnenin 👀", p_peek_sub: "Vier schermen uit een lopend verhaal. 📱",
    ...
    "pl": {
      ...
      p_how_sub: "Szybko zacząć. Bez pośpiechu skończyć. 🌿",
      ...
      p_peek_title: "Zajrzyj do środka 👀", p_peek_sub: "Cztery ekrany z trwającej opowieści. 📱",
    ...
    "tr": {
      ...
      p_how_sub: "Başlaması hızlı. Bitirmesi acelesiz. 🌿",
      ...
      p_peek_title: "İçeriden bir bakış 👀", p_peek_sub: "Devam eden bir hikâyeden dört ekran. 📱",
    ...
    "ar": {
      ...
      p_how_sub: "البداية سريعة. والنهاية بلا عجلة. 🌿",
      ...
      p_peek_title: "نظرة من الداخل 👀", p_peek_sub: "أربع شاشات من قصة جارية. 📱",
