...
(function () {
  ...
  var I18N = {
    ...
    "ja": {
      ...
      p_lead: "ひとつの物語を、それぞれの端末で。<b>カピ</b> が語り、次に何が起こるかを尋ねます——決めるのはペンを持つ人。先を読まれることも、ひとりで待つこともありません。",
      ...
      p_s1t: "1 · 舞台をととのえる",
      p_s1p: "ジャンルを1〜3つ、言語、そして文章の大人っぽさを選びます。登場人物がいれば加えて——全部空欄にして、カピ が何を思いつくか見るのもあり。",
      p_s2t: "2 · コードを共有",
      p_s2p: "みんな4文字で参加。スマホでもブラウザでも。アカウントも登録もメールも不要です。",
      p_s3t: "3 · 順番に書く",
      p_s3p: "カピ が一節を書き、問いかけます。ホストは答える人にペンを渡す——物語はその選択で曲がります。",
